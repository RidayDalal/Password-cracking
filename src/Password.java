...
public class Password {
     ...
     * minimum value. Used ONLY for implementation of front facing src.PasswordStorage.isValidBST()
     * method.
     *
     ...
     * maximum value. Used ONLY for implementation of front facing src.PasswordStorage.isValidBST()
     * method.
     *
    ...
    /**
     * Determines if the argument object is equal to the current instance of a src.Password object.
     *
     * @param obj, the object to check to see if it is equal
     * @return true if obj is a src.Password, occurrences, strength ratings, passwords, and
    ...
    public int compareTo(Password other, Attribute a) {
        ...
        if (a == Attribute.STRENGTH_RATING) {
            if ((this.strengthRating - other.strengthRating) > 0) {
                return 1;
            } else if ((this.strengthRating - other.strengthRating) < 0) {
                return -1;
            } else {
                return 0;
            }
            ...
            if ((this.hashedPassword.compareTo(other.hashedPassword) > 0)) {
                return 1;
            ...
            if ((this.occurrences - other.occurrences) > 0) {
                return 1;
            } else if ((this.occurrences - other.occurrences) < 0) {
                return -1;
            } else {
                return 0;
            }
